...
alias fedora-install='fedora-config install'
alias fedora-update='fedora-config update'
alias fedora-verify='fedora-config verify'
alias update='fedora-config update'
alias a='fedora-config agent'
alias gs='git status'
alias ga='git add'
alias gc='git commit'
alias gp='git push'
